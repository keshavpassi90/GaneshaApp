...
public class KathaFragment extends Fragment {
    ...
    private KathaViewModel kathaViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        if (rootView == null) {
            rootView = inflater.inflate(R.layout.fragment_katha, container, false);
        }
        return rootView;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        kathaViewModel = new ViewModelProvider(requireActivity()).get(KathaViewModel.class);

        if (!kathaViewModel.isDataLoaded()) {
            kathaViewModel.loadData(resId -> getString(resId));
        }

        mHomeList = new ArrayList<>(kathaViewModel.getItemList());
    ...
    void setUpClicks(){
        ...
        backRL.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                NavHostFragment.findNavController(KathaFragment.this).popBackStack();
            }
        });
    ...
    private void handleItemClick(GaneshItem item) {
        InterstitialAdHelper.showAdIfAvailable(requireActivity(), () -> {
            ...
            KathaFragmentDirections.ActionListToDetail action =
                    KathaFragmentDirections.actionListToDetail(item);
