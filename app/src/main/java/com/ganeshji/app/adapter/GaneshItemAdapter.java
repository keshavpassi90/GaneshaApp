...
public class GaneshItemAdapter
        extends RecyclerView.Adapter<GaneshItemAdapter.ItemViewHolder> {
    ...
    private final OnItemClickListener clickListener;   // NEW

    public GaneshItemAdapter(Context context,
